...
$$
avec le vecteur des variables endogènes tel que : $$Y_t = \begin{pmatrix}  \Delta \log R_t \\ \Delta \log  Cas_t\\ \Delta \log Hosp_t \\ \Delta \log Rea_t \\ \Delta \log Décés  \end{pmatrix} $$ Le vecteur des résidus $u_t$ est supposé être i.i.d. tel que $\mathbb{E}[u_t] = 0$, $\mathbb{E}[u_tu_t']=\Sigma$ et $\mathbb{E}[u_tu_{t-1}']=0$.
